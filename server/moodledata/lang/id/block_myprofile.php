...
/**
 * Strings for component 'block_myprofile', language 'id', branch 'MOODLE_37_STABLE'
 *
...
$string['myprofile:myaddinstance'] = 'Tambahkan login baru di blok pengguna ke Beranda saya';
