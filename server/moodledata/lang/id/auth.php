...
/**
 * Strings for component 'auth', language 'id', branch 'MOODLE_37_STABLE'
 *
 * @package   auth
...
$string['enterthenumbersyouhear'] = 'Masukkan angka yang Anda dengar';
$string['enterthewordsabove'] = 'Masukkan kata-kata di atas';
...
$string['getanaudiocaptcha'] = 'Dapatkan CAPTCHA audio';
$string['getanimagecaptcha'] = 'Dapatkan CAPTCHA gambar';
$string['getanothercaptcha'] = 'Dapatkan CAPTCHA lainnya';
