...
/**
 * Strings for component 'enrol', language 'id', branch 'MOODLE_37_STABLE'
 *
 * @package   enrol
...
$string['bulkuseroperation'] = 'operasi pengguna secara massal';
...
$string['extremovedunenrol'] = 'Unenrol pengguna dari kursus';
...
$string['nochange'] = 'Tanpa perubahan';
$string['noexistingparticipants'] = 'Belum ada peserta sebelumnya';
...
$string['participationsuspended'] = 'Ditunda';
...
$string['recovergrades'] = 'Recover nilai lama pengguna jika mungkin';
$string['rolefromcategory'] = '{$a->role} (Warisan dari kategori kursus)';
