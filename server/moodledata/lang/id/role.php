...
/**
 * Strings for component 'role', language 'id', branch 'MOODLE_37_STABLE'
 *
 * @package   role
...
$string['community:add'] = 'Gunakan blok komunitas untuk mencari Moodle.net dan temukan kursus';
$string['community:download'] = 'Unduh kursus dari blok komunitas';
...
$string['notabletooverrideroleshere'] = 'Anda tidak dapat menimpa perizinan pada peranan apapun disini';
