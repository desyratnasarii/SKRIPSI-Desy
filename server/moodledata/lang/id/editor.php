...
/**
 * Strings for component 'editor', language 'id', branch 'MOODLE_37_STABLE'
 *
 * @package   editor
...
$string['acteditorshhdr'] = 'Editor teks tersedia';
...
$string['cols'] = 'Kolom';
$string['configeditorplugins'] = 'Pilihlah plugin editor yang ingin Anda gunakan dan mengaturnya dalam urutan direkomendasikan.';
...
$string['editorsettings'] = 'Mengelola editor';
